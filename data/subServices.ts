...
export const subServices: SubService[] = [
  {
    ...
    durationLabel: "3日〜3週間",
    cardDescription: "対面式で家族団らんに",
  ...
  },
  {
    ...
    durationLabel: "3日〜1週間",
    cardDescription: "寒さ知らずの浴室へ",
  ...
  },
  {
    parentCategory: "personal",
    parentSlug: "reform",
    slug: "windows-insulation",
    title: "窓・断熱リフォーム",
    englishLabel: "Windows & Insulation",
    icon: "Thermometer",
    shortSummary: "内窓・複層ガラスへの交換や壁・床・天井の断熱改修で、夏涼しく冬暖かい住まいへ。",
    durationLabel: "数時間〜1週間",
    cardDescription: "夏涼しく冬暖かい家に",
    heroImage: subServiceImages.windows,
    heroImageAlt: "窓リフォーム後の明るい室内",
    overview: [
      "窓は住まいの中でも熱の出入りが大きい部分です。内窓の設置や複層ガラスへの交換に、壁・床・天井の断熱改修をあわせることで、住まい全体の断熱性能を効率よく高められます。",
      "断熱性能の向上は冷暖房効率の改善による光熱費の削減だけでなく、結露やヒートショックの予防にもつながります。窓だけ、断熱材だけといった部分的なご依頼も承っております。",
    ],
    painPoints: [
      "窓際が冬に冷える、結露がひどい",
      "夏は暑く冬は寒い家をなんとかしたい",
    ...
    priceRanges: [
      ...
      { label: "複層ガラス・サッシの交換", price: "10万円〜30万円" },
      { label: "床下・壁の断熱改修", price: "30万円〜120万円" },
      { label: "住宅全体の断熱リフォーム", price: "150万円〜300万円" },
    ],
    faqItems: [
      {
        id: "windows-insulation-subsidy",
        question: "窓や断熱のリフォームは補助金の対象になりますか？",
        answer: "国や自治体の断熱改修に関する補助金制度の対象になる場合があります。対象となるかどうかも含めてご案内いたします。",
      },
      {
        id: "windows-insulation-effect",
        question: "本当に効果を実感できますか？",
        answer: "特に窓や床下の断熱改修は体感しやすく、冷暖房の効きが良くなったとご実感いただくお客様が多いです。",
      },
      {
        id: "windows-insulation-duration",
        question: "工事は1日で終わりますか？",
        answer: "内窓の設置であれば1箇所あたり数時間程度で完了することが多く、住みながらの工事にも対応しやすい工事です。",
      },
      {
        id: "windows-insulation-partial",
        question: "窓だけ、断熱だけの依頼もできますか？",
        answer: "はい、窓のみ、断熱材のみといった部分的なご依頼からも承っております。",
      },
    ],
    relatedProjectCategory: "住宅リフォーム",
    metaDescription:
  ...
  },
  {
    ...
    durationLabel: "半日〜1週間",
    cardDescription: "将来も安心のバリアフリー",
  ...
  },
  {
    ...
    durationLabel: "3週間〜3ヶ月",
    cardDescription: "住まい全体を丸ごと刷新",
  ...
  },
  {
    ...
    durationLabel: "1ヶ月〜3ヶ月",
    cardDescription: "中古住宅を理想の住まいに",
  ...
  },
  {
    ...
    durationLabel: "3週間〜2ヶ月",
    cardDescription: "マンションを丸ごと再生",
  ...
  },
  {
    ...
    durationLabel: "1日〜1週間",
    cardDescription: "壁紙・床で気分一新",
  ...
  },
  {
    ...
    durationLabel: "3日〜2週間",
    cardDescription: "駐車場・お庭を使いやすく",
  ...
  },
  {
    ...
    durationLabel: "1週間〜1ヶ月",
    cardDescription: "暮らしに合わせ間取り変更",
  ...
  },
  {
    ...
    durationLabel: "1ヶ月〜2ヶ月",
    cardDescription: "部屋を増やす・減らす",
    heroImage: subServiceImages.fullReform,
  ...
  },
  {
    ...
    durationLabel: "2日〜1週間",
    cardDescription: "雨漏り対策",
    heroImage: subServiceImages.roof,
  ...
  },
  {
    ...
    durationLabel: "1日〜2週間",
    cardDescription: "畳・襖を新しく",
  ...
  },
  {
    ...
    durationLabel: "数時間〜1日",
    cardDescription: "小さな困りごとも相談OK",
