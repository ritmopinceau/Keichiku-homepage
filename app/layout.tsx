  ...
  return (
    <html lang="ja">
      <body className="font-sans antialiased">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:bg-white focus:text-charcoal-dark focus:px-4 focus:py-2 focus:rounded-btn"
        >
          本文へスキップ
        </a>
        <MobileMenuProvider>
